...
#'
#' Computation of within subjects standard deviation given two vectors of measurements
#'
...
#'
#' @return The within-subject standard deviation according to QIBA.
#'
...
withinsd <- function(x, y) {
  ...
  cat("Within-subject variance is", d)
